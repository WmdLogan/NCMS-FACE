...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 日志管理 <span class="c-gray en">&gt;</span> 域名监测日志</nav>
<div class="page-container">
    <form action="/NCMS-FACE/public/diary_search" method="post" class="form form-horizontal">
        <div class="text-c">
            ...
            <input type="text"  placeholder="输入要查询的域名关键字"  class="input-text" style="width:250px"  id="keyword" name="keyword">
            <input type="text"  placeholder="输入要查询的欺骗IP"  class="input-text" style="width:250px"  id="cheat_ip" name="cheat_ip">
            日期范围：
            ...
            <input type="hidden"  id="table" name="table" value="7">
            <input type="submit" class="btn btn-success radius" value="查询">
        </div>
    </form>
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:"  onclick="location.href='/NCMS-FACE/public/diary_export?id=10'" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe632;</i> 日志导出</a>
        </span>
    </div>
    <div class="mt-20">
