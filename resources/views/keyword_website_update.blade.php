...
<head>
    ...
    <title>添加网页内容关键字</title>

</head>
<body>
<article class="page-container">
    <form  action="/NCMS-FACE/public/keyword_website_update1" class="form form-horizontal" id="form-member-add">
        <input type="hidden" name="_token" value="{{csrf_token()}}">
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-4"><span class="c-red">*</span>网页内容关键字：</label>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3"style="bottom: -10px;">
    ...
    $(function(){
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type:'post',
                    url:"/NCMS-FACE/public/keyword_website_update1",
