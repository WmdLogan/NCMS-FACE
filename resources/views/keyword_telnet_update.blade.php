...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-5 col-sm-4"><span class="c-red">*</span>请输入TELNET封堵关键字：</label>
    ...
    $(function(){
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type:'post',
                    url:"/NCMS-FACE/public/keyword_telnet_update1",
                    success: function () {
