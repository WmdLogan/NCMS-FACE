...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 日志管理 <span class="c-gray en">&gt;</span> URL封堵日志</nav>
<div class="page-container">
    <form action="/NCMS-FACE/public/diary_search" method="post" class="form form-horizontal">
        <div class="text-c">
            ...
            <input type="hidden"  id="table" name="table" value="5">
            <input type="submit" class="btn btn-success radius" value="查询">
        </div>
    </form>
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:"  onclick="location.href='/NCMS-FACE/public/diary_export?id=8'" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe632;</i> 日志导出</a>
        </span>
    </div>
    <div class="mt-20">
