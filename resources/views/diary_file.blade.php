...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/NCMS-FACE/public/admin/vstatic/h-ui.admin/css/H-ui.admin.css" />
    ...
    <title>爱唱消息内容监测日志</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 日志管理 <span class="c-gray en">&gt;</span> 爱唱消息内容监测日志</nav>
<div class="page-container">
    ...
    <div class="text-c">
        ...
        <br><br>
        <input type="text"  placeholder="输入要查询的日志编号"  class="input-text" style="width:150px" id="log_id" name="log_id">
        <input type="text"  placeholder="输入要查询的文件名"  class="input-text" style="width:250px"  id="keyword" name="keyword">
        <input type="text"  placeholder="输入要查询的文件后缀"  class="input-text" style="width:150px"  id="suffix" name="suffix">
        日期范围：
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:"  onclick="location.href='/NCMS-FACE/public/diary_export?id=2'" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe632;</i> 日志导出</a>
        </span>
    </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td>{{$val -> dport}}</td>
                <td>{{$val -> log_time }}</td>
                <td class="td-manage"><a download="{{$val -> filename}}.{{$val -> suffix}}" href="http://192.168.103.93/{{$val -> filename}}.{{$val -> suffix}}" class="ml-5" style="text-decoration:none" ><i class="Hui-iconfont">&#xe641;</i></a></td>
            </tr>
                @endforeach
            </tbody>
        </table>
...
<script type="text/javascript">
    ...
    function member_del(obj,id){
        layer.confirm( '确认要下载吗？',function(index){
            $.post('/NCMS-FACE/public/download',{
                    'id':id,
                    '_token':"{{csrf_token()}}",
                },
                function (data) {
