...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>请输入域名关键字：</label>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>请输入欺骗IP：</label>
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" class="input-text" value="{{$model->cheat_ip}}" placeholder="" id="cheat_ip" name="cheat_ip">
            </div>
        </div>
        <div class="row cl">
    ...
    $(function(){
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type:'post',
                    url:"/NCMS-FACE/public/keyword_dns_update1",
                    success: function () {
