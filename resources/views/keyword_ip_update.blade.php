...
<article class="page-container">
    <form action="/NCMS-FACE/public/ip_update1" class="form form-horizontal" id="form-member-add">
        <input type="hidden" name="_token" value="{{csrf_token()}}">
        <div class="row cl">
            <label class="form-label col-xs-5 col-sm-4"><span class="c-red">*</span>请输入点分十进制IP地址：</label>
    ...
    $(function(){
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type:'post',
                    url:"/NCMS-FACE/public/ip_update1",
